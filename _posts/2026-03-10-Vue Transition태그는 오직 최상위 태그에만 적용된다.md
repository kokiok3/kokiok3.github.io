...
Vue에서 제공하는 내장 컴포넌트인 \<Transition\>을 사용하면 엘리먼트의 나타남(enter)과 사라짐(leave)에 따른 애니메이션을 구현할 수 있다.
\<Transition\>에 name 속성을 부여하면, 활성화 시점에 따라 .[name]--enter-active, .[name]--leave-active 등 약속된 CSS 클래스가 자동으로 부착된다.
...
---
# 참조
- [Vue.js 트랜지션]([https://blog.naver.com/tombyun/222389000994?trackingCode=blog_bloghome_searchlist](https://ko.vuejs.org/guide/built-ins/transition)){:target="_blank" rel="noopener noreferrer"}
